<style scoped>
    .demo{ background: #e7e7e7; padding: 1.5em 0}
		.main-timeline{
		    position: relative;
...
<script>
import eventCard from './data/event-card.vue';
export default {
    components: {
        eventCard
    }
